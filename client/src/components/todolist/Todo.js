            ...
            <Row>
              ...
              <Col xs="4" sm="4">
                <Row>
                  <Col xs="4" sm="4">
                    <br />
                    <button href="#" id={this.props.todo.id} onClick={this.handleRemove}>Remove</button>
                    {/* <a
                      href=""
                  ...
                  <Col xs="4" sm="4">
                    {" "}
                    <br />
                    <button href="#" id={this.props.todo.id} onClick={this.handleUnvisibil}>Unvisible</button>
                  ...
                  <Col xs="4" sm="4">
                    {" "}
                    <br />
                    <button href="#" id={this.props.todo.id} onClick={this.handleComplete}>Complete</button>
